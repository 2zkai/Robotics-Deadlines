<template>
  <section>
    <el-row>
      <a href="/" class="title">Robotics Conference Deadlines</a>
    ...
    <el-row class="subtitle">
      Robotics Conference Deadline Countdowns. To add/edit a conference, <a style="color: #666666" href="https://github.com/your-username/robotics-deadlines/pulls">send a pull request.</a>
    </el-row>
    <el-row class="subtitle">
     *Disclaimer: The data provided is manually collected and for reference purposes only.
    </el-row>
  </section>
</template>
